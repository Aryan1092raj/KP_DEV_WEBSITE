...
function createTextTexture(gl, text, font = "bold 30px sans-serif", color = "#ffffff") {
  ...
  const textSize = sizeMatch ? Number(sizeMatch[1]) : 30;
...
class Title {
  ...
  createMesh() {
    ...
    this.mesh.position.y = -this.plane.scale.y * 0.5 - textHeight * 0.55;
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: "https://picsum.photos/seed/21/800/600", text: "KP Builder" },
      { image: "https://picsum.photos/seed/22/800/600", text: "Core Team" },
      { image: "https://picsum.photos/seed/23/800/600", text: "Frontend" },
      { image: "https://picsum.photos/seed/24/800/600", text: "Backend" },
      { image: "https://picsum.photos/seed/25/800/600", text: "Systems" },
      { image: "https://picsum.photos/seed/26/800/600", text: "Community" },
    ];
